...
public class InitializableObservableArrayList<T> extends ArrayList<T> implements ObservableList<T> {
	...
	public boolean initialize(Collection<? extends T> collection) {
		boolean added = super.addAll(collection);
		if(added) {
			notifyInitialized();
		}
